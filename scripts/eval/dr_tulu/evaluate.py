...
def main():
    ...
    if args.task == "deep_research_bench":
        ...
        import subprocess
        drb_script = str(Path(__file__).parent / "evaluation" / "deep_research_bench_eval" / "run_eval.py")
        ...
        import subprocess
        sqa_script = str(Path(__file__).parent / "evaluation" / "sqa_eval" / "run_eval.py")
        cmd = [
